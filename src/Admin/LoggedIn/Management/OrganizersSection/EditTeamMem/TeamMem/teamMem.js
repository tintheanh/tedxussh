      ...
      <div className="col-md-6 col-lg-3 mb-2">
        <div className="hotel-room text-center notransition">
          <div className="d-block mb-0 thumbnail notransition">
            <img
              src={this.props.teamMem.picture}
              alt=""
        ...
        <button onClick={this.onDelete.bind(this, this.props.teamMem.id)}>
          Delete
        </button>
      </div>
    ) : (
      <div className="col-md-6 col-lg-3 mb-2">
        <div className="hotel-room text-center notransition">
          ...
          <div className="hotel-room-body">
            ...
            <input
              type="text"
              defaultValue={this.state.newLink}
              onChange={e =>
        ...
        <button onClick={this.onUpdate.bind(this, this.props.teamMem.id)}>
          Save
        </button>
