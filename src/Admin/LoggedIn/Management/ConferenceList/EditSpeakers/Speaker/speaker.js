...
class Speaker extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      newIntroduction: this.props.speaker.introduction,
      newName: this.props.speaker.name,
      newOccupation: this.props.speaker.occupation,
      newPic: this.props.speaker.picture
    };
  ...
  render() {
    return !this.state.toggleEdit ? (
      <div className="col-md-6 col-lg-3 mb-2">
        <div className="hotel-room text-center notransition">
          <div className="d-block mb-0 thumbnail notransition">
            <img
              src={this.props.speaker.picture}
              alt=""
          ...
          <div className="hotel-room-body">
            ...
            >
              {this.props.speaker.introduction}
            </p>
          </div>
        </div>
        ...
        <button onClick={this.onDelete.bind(this, this.props.speaker.id)}>
          Delete
        </button>
      </div>
    ) : (
      <div className="col-md-6 col-lg-3 mb-2">
        ...
        <button onClick={this.onUpdate.bind(this, this.props.speaker.id)}>
          Save
        </button>
