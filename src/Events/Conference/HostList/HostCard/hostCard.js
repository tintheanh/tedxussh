  ...
  render() {
    ...
    return (
      <div className="col-sm-6 col-lg-3 host">
        <div className="hotel-room text-center notransition" onClick={() => this.openModalHost()}>
        ...
        <Modal open={this.state.modalHost} onClose={this.closeModalHost.bind(this)} center>
          <HostInfo host={host} />
        </Modal>
      </div>
    )
